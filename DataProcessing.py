...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Narrow/*.*'):
...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Brown/*.*'):
    img = cv2.resize(cv2.imread(file),(64,64),interpolation=cv2.INTER_CUBIC)
    X.append(img)
    image_list.append(file)
    Image_list.append(file)
...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Paddy/*.*'):
    img = cv2.resize(cv2.imread(file),(64,64),interpolation=cv2.INTER_CUBIC)
    X.append(img)
    image_list.append(file)
    Image_list.append(file)
...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Other/*.*'):
    img = cv2.resize(cv2.imread(file),(64,64),interpolation=cv2.INTER_CUBIC)
    X.append(img)
    image_list.append(file)
    Image_list.append(file)
...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Narrow/Testing/*.*'):
    img = cv2.resize(cv2.imread(file),(64,64),interpolation=cv2.INTER_CUBIC)
    X1.append(img)
...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Brown/Testing/*.*'):
    img = cv2.resize(cv2.imread(file),(64,64),interpolation=cv2.INTER_CUBIC)
    X1.append(img)
    image_list1.append(file)
    Image_list.append(file)
...
for file in glob.glob('C:/Users/Protap Chandra Ghose/Desktop/Database/Paddy/Testing/*.*'):
    img = cv2.resize(cv2.imread(file),(64,64),interpolation=cv2.INTER_CUBIC)
    X1.append(img)
    image_list1.append(file)
    Image_list.append(file)
